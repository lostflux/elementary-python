...
# Date: 09/19/2020
# Purpose: SA 2 Problem 2 -- Using Loops to find year when Brutus's wealth surpassed Portia's.
...
while True:
    ...
    if brutus_value > portia_value:
        print("Brutus's wealth surpassed Portia's wealth in the year:", year)
        print("Brutus's Wealth in", year, "was:", brutus_value)
        print("Portia's Wealth in", year, "was:", portia_value)
        break
