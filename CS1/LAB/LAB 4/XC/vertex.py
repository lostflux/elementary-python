...
class Vertex:
    ...
    def draw_connections(self, r=0, g=0, b=1, path_used=None, frontier=None):
        x1 = self.x
        y1 = self.y
        set_stroke_color(r, g, b)
        ...
        for adjacent_vertex in self.adjacency_list:
            ...
            elif frontier is not None and self in frontier and adjacent_vertex in frontier:
    ...
    def mouse_in_range(self, mx, my):
        return math.sqrt((self.x - mx)**2 + (self.y - my)**2) < 10
