...
# Date: 09/19/2020
# Purpose: SA2 Problem 1 -- Using Loops to compute a compounded value over multiple years.
...
# While Loop to compute compounded value
while year < CURRENT_YEAR:
    value_in_bank *= (1 + BRUTUS_INTEREST_RATE / 100)
    year += 1

# Printing the value:
print("The compounded value in 2020 is:", value_in_bank)
